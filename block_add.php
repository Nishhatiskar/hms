    ...
    <div id="wrapper">
        ...
        <form role="form" action="block_save.php" method="post">
                            ...
                            <input class="form-control" name="id" value="<?php echo $a; ?>" readonly>
                                        ...
                                        <div class="form-group">
                                            <label>Block</label>
                                            <input class="form-control" id="block" type="text" name="block" placeholder="block name" required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control"  name="description" id="description" rows="2" cols="15"  required></textarea>
                                        </div>
