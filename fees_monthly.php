...
?>
 ...
 <div>Pay your remaining fees.....</div>
   ...
   <div>Pay your remaining fees.....</div>
    ...
    <!-- -----------------------------------------------====== /header use ===== ------------------------------------ -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Monthly Rent</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
<form role="form" action="fees_monthly_save.php" method="post">
    ...
    <div class="form-group">
        ...
        <input type="text" name="paidcost" class="form-control" required>                                            
    </div>
    ...
    <div class="form-group">
            ...
            <input type="text" name="payment_date" id="datepicker1" class="form-control" required>                                            
    </div>
