...
?>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Allot Rooms</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
<!-- ------------------------ block -------------------------------- -->
            <div class="form-group">
                        <label>Block</label>
                <select name="block" id="block"  class="form-control" onchange="getblock(this.value);" required>
        ...
        <!-- ------------------------ room -------------------------------- -->
            <div class="form-group">
                ...
                <select name="room" id="room"  class="form-control" onchange="getroom(this.value);" required>
                    <option value="">--select--</option>
